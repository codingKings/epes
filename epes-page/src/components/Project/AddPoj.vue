            ...
            <div class="form-group col-lg-6 col-xs-12" id="pojTypeBox">
              ...
              <div class="col-lg-10" v-if="pojTypes.length > 5">
                <select class="form-control" id="pojType" v-model="pojTypeCode">
                  <option v-for="pojType in pojTypes"  :value='pojType.code' :key="pojType.code">{{ pojType.name }}</option>
                </select>
              </div>
            ...
            <div class="form-group col-lg-6 col-xs-12" id="subTypeBox">
              ...
              <div class="col-lg-10" v-if="subTypes.length > 5">
                <select class="form-control" id="subType" v-model="subTypeCode">
                  <option v-if="pojTypeCode === '' || pojTypeCode === null || pojTypeCode === undefined" style="color: red;" checked>请先选择任务类型</option>
                  <option v-if="(pojTypeCode !== '' && pojTypeCode !== null && pojTypeCode !== undefined ) && subTypes.length <= 0" style="color: red;" checked>该类型未配置子类，请联系管理员添加</option>
                  <option v-for="subType in subTypes" :value='subType.code' :key="subType.code">{{ subType.name }}</option>
                </select>
              </div>
              <div class="col-lg-10" v-else>
                <label v-if="pojTypeCode === '' || pojTypeCode === null || pojTypeCode === undefined" style="color: red;">请先选择任务类型 </label>
                <label v-if="(pojTypeCode !== '' && pojTypeCode !== null && pojTypeCode !== undefined ) && subTypes.length <= 0" style="color: red;">该类型未配置子类，请联系管理员添加 </label>
            ...
            <!--<div class="form-group col-lg-6 col-xs-12">-->
              ...
              <!--<div class="col-lg-10">-->
                <!--<div class="radio radio-inline">-->
                  <!--<input type="radio" id="inlineRadio1"  v-model="type" value="0" name="task_type">-->
                  <!--<label for="inlineRadio1"> 年度任务 </label>-->
                <!--</div>-->
                <!--<div class="radio radio-inline">-->
                  <!--<input type="radio" id="inlineRadio2" v-model="type" value="1" name="task_type">-->
                  <!--<label for="inlineRadio2"> 月度任务 </label>-->
                <!--</div>-->
                <!--&lt;!&ndash;<div class="radio radio-inline">&ndash;&gt;-->
                  <!--&lt;!&ndash;<input type="radio" id="inlineRadio3" v-model="type" value="2" name="task_type">&ndash;&gt;-->
                  <!--&lt;!&ndash;<label for="inlineRadio3"> 临时任务 </label>&ndash;&gt;-->
                <!--&lt;!&ndash;</div>&ndash;&gt;-->
              <!--</div>-->
            <!--</div>-->
